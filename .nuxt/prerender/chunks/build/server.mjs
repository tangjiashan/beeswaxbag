import { hasInjectionContext, getCurrentInstance, inject, defineComponent, ref, h, Suspense, Fragment, createApp, provide, shallowReactive, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, toRef, defineAsyncComponent, mergeProps, getCurrentScope, shallowRef, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'file:///Users/tangjiashan/Desktop/website/yimei/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/tangjiashan/Desktop/website/yimei/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/tangjiashan/Desktop/website/yimei/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///Users/tangjiashan/Desktop/website/yimei/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/tangjiashan/Desktop/website/yimei/node_modules/vue-router/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/tangjiashan/Desktop/website/yimei/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///Users/tangjiashan/Desktop/website/yimei/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/tangjiashan/Desktop/website/yimei/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/tangjiashan/Desktop/website/yimei/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-DDnsQN8z.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-ByzdW_qW.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-OoSD2dcW.mjs')
  },
  {
    name: "products",
    path: "/products",
    component: () => import('./products-DZuT3LLk.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D2Y5cr7u.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-4H3ntE0C.mjs'));
